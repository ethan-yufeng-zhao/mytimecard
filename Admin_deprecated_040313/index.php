<?php
	...
	// $admin_user_arr = array('jcubic', 'shiliang.fan', 'dkennedy', 'dwestfal');
...
<head>
	...
	<link rel="stylesheet" href="plupload/js/jquery.ui.plupload/css/jquery.ui.plupload.css" type="text/css" media="screen, projection">
