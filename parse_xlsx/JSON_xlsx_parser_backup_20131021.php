<?php
	...
	// parse_xlsx/JSON_xlsx_parser.php
	...
	$objPHPExcel = $objReader->load('cert_info.xlsx');
	...
	// echo($objPHPExcel->getActiveSheet()->getCell('A'.$running_row));

	while(strlen(trim($objPHPExcel->getActiveSheet()->getCell('A'.$running_row))) > 0) { //Row must be populated

		$temp_arr = array();
		$temp_arr['email'] = trim($objPHPExcel->getActiveSheet()->getCell('A'.$running_row));
		$temp_arr['lastname'] = trim($objPHPExcel->getActiveSheet()->getCell('B'.$running_row));
		$temp_arr['firstname'] = trim($objPHPExcel->getActiveSheet()->getCell('C'.$running_row));
		$temp_arr['area'] = trim($objPHPExcel->getActiveSheet()->getCell('D'.$running_row));
		$temp_arr['shortname'] = trim($objPHPExcel->getActiveSheet()->getCell('E'.$running_row));
		$temp_arr['name'] = trim($objPHPExcel->getActiveSheet()->getCell('F'.$running_row));
		$temp_arr['startdate'] = trim($objPHPExcel->getActiveSheet()->getCell('G'.$running_row));
		$temp_arr['enddate'] = trim($objPHPExcel->getActiveSheet()->getCell('H'.$running_row));
		$temp_arr['days'] = trim($objPHPExcel->getActiveSheet()->getCell('I'.$running_row));
		$temp_arr['expire'] = trim($objPHPExcel->getActiveSheet()->getCell('J'.$running_row));
		$temp_arr['ert'] = trim($objPHPExcel->getActiveSheet()->getCell('K'.$running_row));
		$temp_arr['safety'] = trim($objPHPExcel->getActiveSheet()->getCell('L'.$running_row));
